...
const preRestorationAssessment = {
  ...
  previousBiophysicalInterventions:{
    ...
    options: ["Restore hydrology - excavate channels",
  ...
  whyUnsuccessfulRestorationAttempt: {
    question: "5.2c If the last restoration/rehabilitation attempt was unsuccessful, please specify why this was the case?",
    options: [
  ...
  naturalRegenerationAtSite: {
    ...
    options: [
      "No",
      "Mangroves have established",
      "Mangroves have established and grown"
    ]
  },
...
const siteInterventions = {
  ...
  biophysicalInterventionDuration: {
    ...
    options: ["Intervention start date",
  ...
  otherActivitiesImplemented: {
    question: "6.4 Were there other activities implemented to address the causes of decline at the site?",
    options: [
...
const costs = {
  supportForActivities:{
    question: "7.1 What type of support was provided for the project activities conducted at the site?",
    options: [
      "Monetary",
  ...
  projectInterventionFunding:{
    question: "7.2 What is the main finance mechanism used to fund the project interventions at the site?",
    options: [
      "Grant based ",
      "Debt/Equity ",
      "Market ",
  ...
  percentageSplitOfActivities:{
    question: "7.5a What was the approximate percentage split in expenditure between the different biophysical interventions and/or community activities?"
  },
  nonmonetisedContributions: {
    question: "7.6 What non-monetised contributions were made to the project activities at the site?",
    options: [
      "Volunteer labour",
...
const managementStatusAndEffectiveness = {
  ...
  stakeholderInfluence: {
    question: "8.3 Are these stakeholders involved in the project activities able to influence management rules at the site?",
    options: [
      "Yes",
      "No",
      "Partially",
  ...
  managementStatusChanges: {
    question: "8.4 Has any aspect of the management status of the site changed since the start of the project activities?",
    options: [
      "Yes",
      "No",
    ]
  ...
  managementLaws: {
    quesiton: "8.4b Are management activities at the site recognized in statutory or customary laws?",
    options: [
      "Yes - statutory ",
      "Yes - customary ",
      "No",
  ...
  projectStatusChange: {
    question: "8.5 Has the protected status of the site changed since the start of the project activities?",
    options: ["Yes","No"]
  },
  ...
  sufficientFunds: {
    question: "8.7 Is the current budget or funds used to support on-going management activities at the site sufficient?",
    options: [
  ...
  resourcesToEnforceRegulations: {
    question: "8.8 Do those responsible for on-going management at the site (e.g., staff, community associations, management groups) have sufficient capacity and resources to enforce the rules and regulations?",
    options: [
  ...
  equitableSharingOfSiteBenefits: {
    question: "8.9 Is there an effective strategy or approach for ensuring benefits from the site are shared equitably among local stakeholders?",
    options: [
...
const socioeconomicGovernanceStatusOutcomes = {
  dateOfOutcomesAssessment:{
    question: "9.1 What date was this socioeconomic and governance status and outcomes assessment conducted?"
  },
  changeInGovernance:{
    question: "9.2 Has the governance arrangement of the site changed since the start of the project activities?",
    options: ["Yes", "No"]
  },
  currentGovenance:{
  ...
  changeInTenureArrangement:{
    question: "9.3 Has the tenure arrangement of the site changed since the start of the project activities?",
    options:["Yes", "No"]
  },
...
const ecologicalStatusOutcomes ={
  ...
  percentageSurvival:{
    question: "10.6 What was the percentage survival of the planted mangrove seedlings or propagules?"
  },
  causeOfLowSurvival: {
...
export { restorationAims, projectDetails, siteBackground, preRestorationAssessment, siteInterventions, costs, managementStatusAndEffectiveness, socioeconomicGovernanceStatusOutcomes, ecologicalStatusOutcomes}
