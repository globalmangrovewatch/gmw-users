// this file is for temporarily working on the ui with the absence of a supporting API endpoint

const mockOrganizations = [
  { id: 1, name: 'Fake Org 1', isCurrentUserMember: false },
  { id: 2, name: 'Fake Org 2', isCurrentUserMember: false },
